...
JVM_OPTS=${CALCENTRAL_JVM_OPTS:="\-Xms4816m \-Xmx4816m \-XX:+UseG1GC \-XX:+PrintGCCause \-XX:+PrintGCDateStamps \-XX:+PrintGCDetails \-XX:+ScavengeBeforeFullGC \-XX:+UseCodeCacheFlushing \-XX:MaxMetaspaceSize=1024m \-XX:ReservedCodeCacheSize=256m"}
