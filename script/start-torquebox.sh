...
JVM_OPTS=${CALCENTRAL_JVM_OPTS:="\-server \-verbose:gc \-Xms3000m \-Xmx3000m \-XX:+UseG1GC \-XX:MaxGCPauseMillis=200 \-XX:+PrintGCCause \-XX:+PrintGCDateStamps \-XX:+PrintGCDetails \-XX:+UseCodeCacheFlushing \-XX:MaxMetaspaceSize=1024m \-XX:ReservedCodeCacheSize=256m"}
